<template>
  <div class="user-wrapper">
    <div class="content-box" style="display:inline-flex">
      ...
      <a-dropdown>
        <span style="margin:0 10px;" class="action ant-dropdown-link user-dropdown-menu">
          <a-avatar class="avatar" size="small" :src="avatar" />
          <span style="padding-left:5px">{{ nickname }}</span>
        </span>
    ...
    <a-modal title="切换应用" :visible="visible" :footer="null" :confirm-loading="confirmLoading" @cancel="handleCancel">
      <a-form :form="form1">
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="选择应用">
          <a-menu mode="inline" :default-selected-keys="this.defApp" style="border-bottom:0px;lineHeight:72px;">
