        ...
        <a-row :gutter="24">
          ...
          <a-col :span="12">
            <a-form-item
              ...
              has-feedback
            >
              <a-input type="number" placeholder="请输入X坐标" v-decorator="['xcoor', {rules: [{required: true, message: '请输入X坐标！'}]}]" />
            </a-form-item>
          </a-col>
        </a-row>
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item
              ...
              has-feedback
            >
              <a-input type="number" placeholder="请输入Y坐标" v-decorator="['ycoor', {rules: [{required: true, message: '请输入Y坐标！'}]}]" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item
...
<script>
  import { combAdd } from '@/api/modular/main/comb/combManage'
  export default {
    data () {
      return {
        labelCol: {
