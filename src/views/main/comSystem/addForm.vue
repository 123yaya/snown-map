<template>
  <a-modal title="新增排水系统" :width="900" :visible="visible" :confirmLoading="confirmLoading" @ok="handleSubmit" @cancel="handleCancel" :maskClosable="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :span="12">
            <a-form-item label="系统类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-select style="width: 100%" placeholder="请选择系统类型">
...
<script>
import { systemAdd } from '@/api/modular/main/system/systemManage'
