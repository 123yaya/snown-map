<template>
  <div class="menu-list">
    ...
    <a-card :bordered="false">
      <s-table ref="table" :rowKey="(record) => record.id" :columns="columns" :alert="false" :data="loadData" :showPagination="false" :expandRowByClick="true">
...
<style scoped>
.menu-list {
  margin: -12px -14px 20px 0px !important;
  padding-bottom: 20px;
}
.table-operator {
  margin-bottom: 18px;
