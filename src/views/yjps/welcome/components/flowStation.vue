<template>
  <div class="devicePanel" v-if="flowStation">
    ...
    <div class="inline-flex-box">
      <div class="inline-flex-left">
        ...
        <div class="detail-box">
          <p><span>最近采集</span><span>2022-04-24 17:15:00</span></p>
          <p><span>fid</span><span>00GZ030038</span></p>
        </div> -->
      </div>
