<template>
  <div class="devicePanel" v-if="flowStationDetail">
    ...
    <div class="devicePanel-bot">
      ...
      <!-- <a-form layout="inline" class="form-left">
        <a-button type="primary" style="margin-right:10px">
          <check-circle-outlined />
          瞬时流量
        </a-button>
        <a-button type="primary" danger style="margin-right:10px">
          <check-circle-outlined />
          流速
        </a-button>
        <a-button type="primary" style="margin-right:10px">
...
export default {
  name: 'FlowStationDetail',
  components: { previewImg },
  data () {
    return {
      flowStationDetail: false,
      form: {
        type: '1'
      },
  ...
  methods: {
    moment,
    showFlowStationDetail (layerId, id) {
