<template>
  <div class="container">
    ...
    <a-layout :class="['layout', device]">
      ...
      <side-menu v-else-if="isSideMenu()" mode="inline" :menus="menus" :theme="navTheme" :collapsed="collapsed" :collapsible="true" @toggle="toggle"></side-menu>

      <a-layout :class="[layoutMode, `content-width-${contentWidth}`]" :style="{ paddingLeft: contentPaddingLeft, height: '100%',overflow: 'hidden'}">
